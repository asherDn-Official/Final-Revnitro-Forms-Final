...
const BikeService = require("../modals/BikeServiceInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new service request record using the Mongoose model
    const newServiceRequest = new BikeService({
      customerName: details.personname,
      email: details.email,
      phone: details.phoneNo,
      location: details.location,
      address: details.address,
      bikeName: details.bikename,
