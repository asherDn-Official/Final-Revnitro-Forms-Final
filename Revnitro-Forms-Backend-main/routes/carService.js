...
const CarService = require("../modals/CarServiceInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new car service request record using the Mongoose model
    const newServiceRequest = new CarService({
      ...
      issue: details.issues,
      serviceLocation: details.serviceloction,
    });
                ...
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/CarServiceBooking"
                      >forms.revnitro.com/CarServiceBooking</a
                    ></span
                  >
