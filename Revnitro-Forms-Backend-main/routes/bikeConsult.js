...
const BikeConsultation = require("../modals/BikeConsultationInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    const newConsultation = new BikeConsultation({
      bikeType: details.bikeType,
      bikeBrand: details.bikename,
                ...
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/BikeConsultation"
                      >forms.revnitro.com/BikeConsultation</a
                    ></span
                  >
