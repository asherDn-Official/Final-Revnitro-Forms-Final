...
const BusinessCollaboration = require("../modals/BusinessColaborationInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new business collaboration request record using the Mongoose model
    const newCollaborationRequest = new BusinessCollaboration({
            ...
            <div class="widthdiv">
              ...
              <div>
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/BusinessCollabration"
                      >forms.revnitro.com/BusinessCollabration</a
                    ></span
                  >
