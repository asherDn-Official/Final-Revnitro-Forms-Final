...
const CarConsultation = require("../modals/CarConsultationInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new car consultation request record using the Mongoose model
    const newConsultationRequest = new CarConsultation({
      carType: details.cartype,
      carBrand: details.carname,
    ...
    await newConsultationRequest.save();
                ...
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/CarConsultation"
                      >forms.revnitro.com/CarConsultation</a
                    ></span
                  >
