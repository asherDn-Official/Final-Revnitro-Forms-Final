...
const ApplyJob = require("../modals/ApplyJobInbox");
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new application record using the Mongoose model
    const newApplication = new ApplyJob({
      jobType: details.jobtype,
      jobTitle: details.jobTitle,
      applicantName: details.personname,
      age: details.age,
      email: details.email,
            ...
            <div class="widthdiv">
              ...
              <div>
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/Applyjob"
                      >forms.revnitro.com/Applyjob</a
                    ></span
                  >
