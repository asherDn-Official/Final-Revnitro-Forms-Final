...
router.post("/", async (req, res) => {
  try {
    ...
    // Create a new ownership review request record using the Mongoose model
    const newReviewRequest = new OwnershipReview({
      vehicleType: details.type,
      vehicleModel: details.model,
      makeYear: details.year,
      ownerName: details.personname,
      email: details.email,
