...
const EcuTuning = require("../modals/EcuTuningInbox"); // Import the Mongoose model
var router = express.Router();
router.post("/", async (req, res) => {
  try {
    const details = await req.body;
    // Create a new ECU tuning request record using the Mongoose model
    const newTuningRequest = new EcuTuning({
                ...
                <div class="paras">
                  ...
                  <span
                    ><a href="https://forms.revnitro.com/EcuTuning"
                      >forms.revnitro.com/EcuTuning</a
                    ></span
                  >
