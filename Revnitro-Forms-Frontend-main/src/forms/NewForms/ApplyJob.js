    ...
    <div>
      <div className="carpurchaseform">
        <Helmet>
          ...
          <meta
            name="description"
            content="Launch your career at RevNitro! Explore open positions & internships across various departments. We offer a dynamic work environment & opportunities htmlFor growth. Apply today!"
          />
        </Helmet>
        <div
        ...
        >
          <div className="form-container">
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label htmlFor="Name">Link of Resume or Portfolio</label>
                <input
                  type="text"
                  name="resume"
                  value={formDetails.resume}
